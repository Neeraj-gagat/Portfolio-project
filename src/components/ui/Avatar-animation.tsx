...
const Avatar = () => {
  return (
    <div className="relative order-first shrink p-4 md:order-last md:p-4">
      <a href="https://x.com/Neeraj_tw " target="__blank">
        <motion.div
          initial={{ opacity: 0, filter: 'blur(10px)' }}
          whileInView={{ opacity: 1, filter: 'blur(0px)' }}
          transition={{ duration: 0.5, delay: 0.7 }}
          viewport={{ once: true }}
          className="relative z-[5] block size-16 md:size-20 max-h-20 max-w-20 overflow-hidden rounded bg-white shadow-xl ring-1 ring-slate-900/5"
        >
          <img
