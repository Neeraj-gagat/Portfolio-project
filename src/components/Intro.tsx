...
export const Intro = () => {
    ...
    return <div className="content-center bg-gradient-to-b from-purple-100 via-pink-100 to-white  text-neutral-950 text-4xl text-center" id="home">
        ...
        <div className="flex justify-center space-x-8 mt-10">
            <button className="focus:scale-[1.15] hover:scale-[1.15] transition bg-gray-900 hover:bg-black text-white px-7 py-3 text-xl rounded-full shadow-xl flex">Contact Me Here
                 <div className="flex pt-1 size-8 text-white pl-2"><BsArrowRight/></div>
            </button>
            <button className="focus:scale-[1.15] hover:scale-[1.15] transition hover:bg-gray-200 active:scale-105 text-black bg-slate-100 px-7 py-3 text-xl border rounded-full shadow-xl flex">Download CV
