...
export const Intro = () => {
    ...
    return <div className=" content-center bg-customstag  text-neutral-950 text-4xl text-center" id="home">
        ...
        <div className="flex flex-col justify-center gap-[1.3rem] px-4 sm:flex-row items-center text-lg font-medium mx-11 mt-10">
            ...
            <a href="/Resume.pdf" download="Resume.pdf" className="focus:scale-[1.10] hover:scale-[1.10] transition hover:bg-customcreamd active:scale-105 text-black bg-customcream px-7 py-2.5 text-lg border-black rounded-full shadow-xl flex">Download CV
