...
export const Intro = () => {
    ...
    return <div className="content-center bg-gradient-to-b from-purple-200 via-pink-100 to-white  text-neutral-950 text-4xl text-center" id="home">
        ...
        <div className="flex flex-col justify-center gap-[1.3rem] px-4 sm:flex-row items-center text-lg font-medium mx-11 mt-10">
            <button className="focus:scale-[1.10] hover:scale-[1.10] transition bg-gray-900 hover:bg-black text-white gap-2 px-7 py-3 text-lg rounded-full shadow-xl flex">Contact Me Here
                 <div className="flex pt-1 size-8 text-white pl-2"><BsArrowRight/></div>
            </button>
            <button className="focus:scale-[1.10] hover:scale-[1.10] transition hover:bg-gray-200 active:scale-105 text-black bg-slate-100 px-7 py-3 text-lg border rounded-full shadow-xl flex">Download CV
