...
export const AppBar = () =>{
    return <div className="shadow-xl border-b flex justify-center fixed z-[999] top-0 left-0 right-0 mx-auto px-0 w-3/6 py-4 bg-white rounded-full mt-4 space-x-4 ">
