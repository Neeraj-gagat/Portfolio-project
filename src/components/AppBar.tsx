...
export const AppBar = () =>{
    ...
    return <motion.div 
    className="shadow-xl left-1/2 h-[4.5rem] top-1 sm:top-2 sm:h-[3.25rem] sm:w-[35rem] rounded-xl sm:rounded-full border-b flex pt-4 backdrop-blur-[0.5rem] border-opacity-40 bg-opacity-75 justify-center fixed sm:fixed z-[999] mx-auto  w-[25rem] py-4 bg-white mt-5"
