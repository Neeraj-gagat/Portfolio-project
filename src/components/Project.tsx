...
export const Project = ({
  ...
  return (
    ...
    >      
    <CardContainer className="inter-var bg-gray-100 shadow-xl rounded-lg max-w-[42rem] border-x overflow-hidden pr-10 sm:pr-8 relative h-[13rem] sm:h-[24rem]  hover:bg-gray-200 transition ">
