...
export const Project = ({
  ...
  return (
    ...
    >      
    <CardContainer className="inter-var bg-customcream shadow-xl rounded-lg max-w-[42rem] overflow-hidden pr-10 sm:pr-8 relative h-[13rem] sm:h-[24rem]  hover:bg-customcreamd transition ">
